/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 2cd60c4a46ad6d9b1b6e837b78397d1b)
// Runtime types generated with workerd@1.20260421.1 2025-04-04 nodejs_compat
declare namespace Cloudflare {
	...
	interface Env {
		...
		BATTLE_ROOM: DurableObjectNamespace<import("./workers/app").BattleRoom>;
		CONTENT_WORKFLOW: Workflow<Parameters<import("./workers/app").ContentGenerationWorkflow['run']>[0]['payload']>;
		BATTLE_QUESTION_WORKFLOW: Workflow<Parameters<import("./workers/app").BattleQuestionGenerationWorkflow['run']>[0]['payload']>;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PUBLIC_URL" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "GITHUB_CLIENT_ID" | "GITHUB_CLIENT_SECRET" | "TURNSTILE_SECRET_KEY">> {}
}
